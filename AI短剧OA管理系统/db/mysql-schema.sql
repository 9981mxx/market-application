...
CREATE TABLE IF NOT EXISTS withdrawal_requests (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  KEY withdrawals_requester_idx (requester_account_id),
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  KEY notifications_recipient_idx (recipient_account_id, is_read, created_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE IF NOT EXISTS file_assets (
  id VARCHAR(64) PRIMARY KEY,
  uploader_account_id VARCHAR(64) NOT NULL,
  original_name VARCHAR(255) NOT NULL,
  storage_key VARCHAR(512) NOT NULL,
  mime_type VARCHAR(128) NOT NULL,
  size BIGINT NOT NULL,
  checksum VARCHAR(128) NOT NULL,
  storage_backend VARCHAR(32) NOT NULL DEFAULT 'd1',
  content MEDIUMBLOB NULL,
  status VARCHAR(32) NOT NULL DEFAULT 'active',
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  UNIQUE KEY file_assets_storage_key_uq (storage_key),
  KEY file_assets_uploader_idx (uploader_account_id, created_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS backup_runs (
  ...
  KEY backup_runs_created_idx (created_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
