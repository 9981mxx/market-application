...
async function seedRolesAndPermissions(db: D1Database): Promise<void> {
  ...
  const permissions: Record<string, string[]> = {
    super_admin: ["account.read", "account.write", "channel.read", "channel.write", "user.read", "user.write", "invitation.read", "invitation.write"],
    market: ["account.read", "channel.read", "channel.write", "user.read", "user.write", "invitation.read", "invitation.write"],
    franchise: ["channel.read", "user.read", "invitation.read", "invitation.write"],
    agent: ["user.read", "invitation.read", "invitation.write"],
  };
